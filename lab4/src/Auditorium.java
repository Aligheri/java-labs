...
public class Auditorium {
    ...
    public Auditorium() {
        this.number = 0; this.capacity = 0;
        this.type = "lecture"; this.floor = 1; this.occupied = false;
        totalCount++;
    }

    public Auditorium(int number, int capacity, String type, int floor) {
        this.number = number; this.capacity = capacity;
        this.type = type; this.floor = floor; this.occupied = false;
        totalCount++;
    }

    public Auditorium(int number, int capacity, String type, int floor, boolean occupied) {
        this.number = number; this.capacity = capacity;
        this.type = type; this.floor = floor; this.occupied = occupied;
        totalCount++;
    }
